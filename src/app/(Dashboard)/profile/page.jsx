...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-200 to-blue-300 text-gray-900">
            <div className="flex justify-center items-center min-h-screen">
                <div className="w-full max-w-4xl p-6 my-8 bg-white rounded-lg shadow-lg flex flex-col items-center">
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <ul className="mt-2 mb-4 space-y-3">
                            ...
                            <h1 className="text-lg font-semibold mt-2 text-blue-600">Your Task Activity Overview</h1>
                            <StreakComponent streak={streak}></StreakComponent>
                            <TaskHeatmap taskData={taskData}></TaskHeatmap>
                            <button
                                className=" bg-rose-600 text-white py-2 px-4 rounded-lg hover:bg-rose-500 transition duration-300"
                                onClick={async () => {
